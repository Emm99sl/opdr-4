...
with tab1:
       ...
       with st.expander('Zie code'):
              plot_code0 = '''fig0 = px.bar(df, x = "jaar_order", y = "Profit", title= "Histogram: Winst per jaar")
       ...
       with st.expander('Zie code'):
              plot_code4 = '''fig4 = px.histogram(df, x = "Profit", title = "Histogram: Winst", nbins = 100)
       fig4.update_xaxes(title_text = "Winst in $")
       fig4.update_yaxes(title_text = "Aantal Superstores")
       st.plotly_chart(fig4)'''
              st.code(plot_code4)

       fig4 = px.histogram(df, x = "Profit", title = "Histogram: Winst", nbins = 100)
       fig4.update_xaxes(title_text = "Winst in $")
       fig4.update_yaxes(title_text = "Aantal Superstores")
       st.plotly_chart(fig4)
